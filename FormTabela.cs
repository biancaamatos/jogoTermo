...
namespace TermoApp
{
    public class FormTabela : Form
    {
        ...
        private Label lblWins, lblLosses, lblTotal, lblAvg;
        ...
        private void InitializeComponents()
        {
            ...
            // STATS: 3 cartões principais (Vitórias, Derrotas, Partidas) + opcional média
        ...
        // OverlayLabel dentro do bg mostra a contagem "atrás" da barra
        private TableLayoutPanel CreateBarRowUniform(int index)
        {
            ...
            // overlay no bg (aparece "atrás" da barra, alinhado à direita do bg)
            ...
            // adicionar overlay primeiro para ficar atrás da barra
        ...
        private void RefreshStats()
        {
            ...
            double avg = attempts.Count > 0 ? attempts.Average() : 0.0;

            lblWins.Text = wins.ToString();
            lblLosses.Text = losses.ToString();
            lblTotal.Text = total.ToString();
            lblAvg.Text = $"{avg:0.00}";
