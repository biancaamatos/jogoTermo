...
namespace TermoApp
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            foreach (Control ctrl in this.Controls) if (ctrl is Button btn && btn.Name.StartsWith("btn")) ConfiguraBotaoCustom(btn);
        }
        ...
        private async void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            if (palavra.Length != 5 || !termo.EstaNoDicionario(palavra))
            {
                TocarSom("erro.wav");
